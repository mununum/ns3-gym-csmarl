...
int main (int argc, char *argv[])
{
    ...
    for (uint32_t i = 0; i < numAgents; i++) {
        ...
        rmac->TraceConnectWithoutContext("TxOkHeader", MakeBoundCallback (&MyGymEnv::SrcTxDone, myGymEnv, node, i));
        rmac->TraceConnectWithoutContext("TxErrHeader", MakeBoundCallback (&MyGymEnv::SrcTxFail, myGymEnv, node, i));
    }
